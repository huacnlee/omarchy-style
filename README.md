...
├── examples/                         # Community design examples
├── references/                       # External visual references
└── wallpapers/                       # Wallpaper studies
```
...
- [Community examples](assets/examples/)

## Example work

| Chicago | Hong Kong |
|---|---|
| ![Chicago pixel city](assets/examples/chicago/pixel-lake-breeze-city.png) | ![Hong Kong pixel harbor](assets/examples/hong-kong/pixel-harbor-city.png) |

| New York | Singapore |
|---|---|
| ![New York pixel harbor](assets/examples/new-york/pixel-harbor-city.png) | ![Singapore pixel city](assets/examples/singapore/pixel-marina-city.png) |
